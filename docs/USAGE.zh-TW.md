...
目前 MVP UI 尚不能直接選擇 LM Studio 或其他 OpenAI-compatible servers。這類服務通常會提供 `http://localhost:1234/v1` 這樣的 base URL；PCFA 需要先實作對應 provider settings，才能用它們進行 feed analysis。
