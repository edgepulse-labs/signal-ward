(() => {
  ...
  const MESSAGES = {
    en: {
      ...
      platformComparisonTitle: "Platform Comparison",
      platformComparisonEmpty: "No platform comparison yet.",
      platformComparisonLeader: "{platform} currently has the strongest average toxicity at {toxicity}.",
      platformColumn: "Platform",
      platformAnalyzedColumn: "Analyzed",
      platformAvgToxicityColumn: "Avg toxicity",
      platformAvgAngerColumn: "Avg anger",
      platformHighToxicityColumn: "High toxic",
      platformX: "X",
    ...
    "zh-TW": {
      ...
      platformComparisonTitle: "平台比較",
      platformComparisonEmpty: "尚無平台比較資料。",
      platformComparisonLeader: "目前平均毒性最高的是 {platform}，平均 {toxicity}。",
      platformColumn: "平台",
      platformAnalyzedColumn: "已分析",
      platformAvgToxicityColumn: "平均毒性",
      platformAvgAngerColumn: "平均憤怒",
      platformHighToxicityColumn: "高毒性",
      platformX: "X",
      platformThreads: "Threads",
      platformFacebook: "Facebook",
