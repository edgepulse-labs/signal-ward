(() => {
  ...
  const MESSAGES = {
    en: {
      ...
      ollamaNotChecked: "Provider not checked",
      ...
      verifyWebLlm: "Use the check button to load the browser-local WebLLM model.",
      checkButton: "Check",
      ...
      toxicityCollapseThresholdLabel: "Toxicity collapse threshold",
      angerCollapseThresholdLabel: "Anger collapse threshold",
      collapseAdsLabel: "Collapse confirmed ads by default",
      ...
      modelDebugModeLabel: "Store model debug traces locally",
      shareStatsWithServerLabel: "Help publish anonymous statistics to a server",
      enableCollectiveDefenseLabel: "Enable collective defense suggestions",
      cloudOptInNote:
        "Cloud collaboration is off by default. When enabled, future server features may receive toxic-signal statistics or use collective defense judgments.",
      saveSettingsButton: "Save settings",
      recentSignalsTitle: "Recent Signals",
      categoryDetailsTitle: "Category Details",
      dailyRollupTitle: "Daily Rollup",
      modelDebugTitle: "Model Debug",
      clearModelDebugButton: "Clear",
      modelDebugNote:
        "Enable debug mode, refresh the feed, then inspect the latest local model responses here.",
      modelDebugEmpty: "No model debug traces yet.",
      modelDebugSummary: "{status} · {provider} · {parseStatus} · toxicity {score}",
      debugStatusOk: "OK",
      debugStatusFailed: "Failed",
      debugCheckedAt: "Checked at",
      debugModel: "Model",
      debugHttpStatus: "HTTP status",
      debugEndpoint: "Endpoint",
      debugNormalizedScores: "Normalized scores",
      debugClassification: "Classification",
      debugRawResponseShape: "Response shape",
      debugError: "Error",
      debugRawModelContent: "Raw model content",
      debugParsedJson: "Parsed JSON",
      debugNoRawContent: "No raw message content recorded.",
      debugNoParsedJson: "No parsed JSON recorded.",
      copyRequestButton: "Copy request",
      copyResponseButton: "Copy response",
      copyTraceButton: "Copy full trace",
      copiedButton: "Copied",
      ...
      recentDetail: "{confidence} confidence · {contentType} · {reason}",
      ...
      statsSharingEnabled: "Statistics sharing enabled",
      collectiveDefenseEnabled: "Collective defense enabled",
      availableFromPanel: "Available from this panel",
      date: "Date",
      sources: "Sources",
      avgEmotion: "Avg emotion",
      avgPropaganda: "Avg propaganda",
      rollupSources: "{webllm} WebLLM / {ollama} Ollama / {openai} OpenAI-compatible / {heuristic} heuristic",
      checkingProvider: "Checking {provider}...",
      checkingWebLlm: "Loading the browser-local WebLLM model.",
      ...
      modelsFound: "{count} models available. Pick one from the model field or type a custom id.",
      noLocalModels: "No local models reported by Ollama.",
      webLlmReady: "WebLLM model is ready.",
      webLlmProgressPercent: "{percent}%",
      webLlmLoadingDetail: "Loading WebLLM model: {percent}% · {detail}",
      providerWebLlm: "WebLLM",
      providerOpenAICompatible: "OpenAI-compatible",
      providerOllama: "Ollama",
      endpointHeuristicOnly: "Local heuristic only",
      endpointOpenAICompatible: "Local OpenAI-compatible ({url})",
      endpointWebLlmFallback: "Browser-local WebLLM / heuristic fallback",
      ...
      badgeAnger: "Anger",
      badgeInfo: "Info",
      badgeContentType: "Type",
      badgeUncertain: "Uncertain",
      badgeConfidence: "Confidence",
      contentClassAd: "Ad",
      contentClassPropaganda: "Propaganda",
      contentClassChitchat: "Chitchat",
      contentClassInformational: "Informational",
      contentClassOpinion: "Opinion",
      contentClassUnknown: "Unknown",
      heuristicExplanation: "Heuristic explanation",
      localModelExplanation: "Local model explanation",
      reanalyzeTitle: "Analyze again",
      feedbackButton: "Report",
      feedbackTitle: "Report wrong analysis",
      feedbackReported: "Reported",
      feedbackFailed: "Failed",
      summaryLabel: "Summary",
      modelFallbackNotice: "Model fallback: {reason}",
      uncertainDetail: "Uncertain: this estimate has low model or extraction confidence.",
      showOriginal: "Show original",
      collapsedNotice: "Collapsed by local estimate: toxicity {toxicity}, anger {anger}, type {contentType}.",
      ...
      promptInstructions:
        "Analyze only the observable text below. Do not decide political truth. Do not classify ideology. Separate disagreement from toxicity. Return JSON only. Classify the primary content type as one of: ad, propaganda, chitchat, informational, opinion, unknown. Write explanation reasons and summary in English.",
    ...
    "zh-TW": {
      ...
      toxicityCollapseThresholdLabel: "毒性收疊門檻",
      angerCollapseThresholdLabel: "憤怒收疊門檻",
      collapseAdsLabel: "已確認廣告預設收疊",
      retentionDaysLabel: "保留天數",
      heuristicOnlyLabel: "只使用啟發式模式",
      storeRawTextLabel: "在本機儲存可見原文",
      modelDebugModeLabel: "在本機儲存模型除錯紀錄",
      shareStatsWithServerLabel: "協助發佈匿名統計資訊到伺服器",
      enableCollectiveDefenseLabel: "啟用聯防摺疊建議",
      cloudOptInNote:
        "雲端協作預設關閉。啟用後，未來伺服器功能可能接收有毒訊號統計，或使用聯防判斷。",
      saveSettingsButton: "儲存設定",
      recentSignalsTitle: "最近訊號",
      categoryDetailsTitle: "分類細節",
      dailyRollupTitle: "每日彙總",
      modelDebugTitle: "模型除錯",
      clearModelDebugButton: "清除",
      modelDebugNote:
        "啟用除錯模式後，重新整理 feed，再到這裡查看最新的本機模型回應。",
      modelDebugEmpty: "尚無模型除錯紀錄。",
      modelDebugSummary: "{status} · {provider} · {parseStatus} · 毒性 {score}",
      debugStatusOk: "成功",
      debugStatusFailed: "失敗",
      debugCheckedAt: "檢查時間",
      debugModel: "模型",
      debugHttpStatus: "HTTP 狀態",
      debugEndpoint: "端點",
      debugNormalizedScores: "正規化分數",
      debugClassification: "分類",
      debugRawResponseShape: "回應結構",
      debugError: "錯誤",
      debugRawModelContent: "模型原始內容",
      debugParsedJson: "解析後 JSON",
      debugNoRawContent: "沒有記錄模型原始內容。",
      debugNoParsedJson: "沒有記錄解析後 JSON。",
      copyRequestButton: "複製 request",
      copyResponseButton: "複製 response",
      copyTraceButton: "複製完整 trace",
      copiedButton: "已複製",
      ...
      recentDetail: "{confidence} 信心度 · {contentType} · {reason}",
      categoryToxicity: "毒性",
      categoryAnger: "憤怒",
      categoryFear: "恐懼",
      ...
      statsSharingEnabled: "統計資訊分享已啟用",
      collectiveDefenseEnabled: "聯防已啟用",
      availableFromPanel: "可從此面板執行",
      date: "日期",
      sources: "來源",
      avgEmotion: "平均情緒",
      avgPropaganda: "平均宣傳風險",
      rollupSources: "{webllm} WebLLM / {ollama} Ollama / {openai} OpenAI-compatible / {heuristic} 啟發式",
      checkingProvider: "正在檢查 {provider}...",
      checkingWebLlm: "正在載入瀏覽器本地端 WebLLM 模型。",
      ...
      modelsFound: "找到 {count} 個可用模型。可從模型欄位選擇，或自行輸入模型 ID。",
      noLocalModels: "Ollama 未回報本機模型。",
      webLlmReady: "WebLLM 模型已就緒。",
      webLlmProgressPercent: "{percent}%",
      webLlmLoadingDetail: "正在載入 WebLLM 模型：{percent}% · {detail}",
      providerWebLlm: "WebLLM",
      providerOpenAICompatible: "OpenAI-compatible",
      providerOllama: "Ollama",
      endpointHeuristicOnly: "僅本機啟發式",
      endpointOpenAICompatible: "本機 OpenAI-compatible（{url}）",
      endpointWebLlmFallback: "瀏覽器本地端 WebLLM / 啟發式備援",
      ...
      badgeConfidence: "信心度",
      contentClassAd: "廣告",
      contentClassPropaganda: "宣傳",
      contentClassChitchat: "閒聊",
      contentClassInformational: "資訊",
      contentClassOpinion: "意見",
      contentClassUnknown: "未知",
      heuristicExplanation: "啟發式說明",
      localModelExplanation: "本機模型說明",
      reanalyzeTitle: "重新分析",
      feedbackButton: "回報",
      feedbackTitle: "回報判斷錯誤",
      feedbackReported: "已回報",
      feedbackFailed: "失敗",
      summaryLabel: "摘要",
      modelFallbackNotice: "模型已退回啟發式：{reason}",
      uncertainDetail: "不確定：此估計的模型或擷取信心度偏低。",
      showOriginal: "顯示原文",
      collapsedNotice: "已依本機估計收疊：毒性 {toxicity}、憤怒 {anger}、類型 {contentType}。",
      pageMarker: "PCFA 本機",
      ...
      promptRetry:
        "Your previous response could not be parsed as JSON. Return only valid JSON using the required schema.",
      promptInstructions:
        "Analyze only the observable text below. Do not decide political truth. Do not classify ideology. Separate disagreement from toxicity. Return JSON only. Classify the primary content type as one of: ad, propaganda, chitchat, informational, opinion, unknown. Write explanation reasons and summary in Traditional Chinese.",
      promptVisiblePlatform: "Visible platform",
      promptVisibleAuthorHandle: "Visible author handle",
      promptVisibleText: "Visible text",
      promptUnknown: "unknown"
